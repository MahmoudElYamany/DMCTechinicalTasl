...
INSERT INTO categories(ID, Cat_Desc) VALUES
(1 , 'Accessories'),
(2 , 'Fitness'),
(3 , 'Clothing'),
(4 , 'Electronics'),
...
INSERT INTO Countries (country_id, Sort_Name , Country_Name, Phone_Code) VALUES
(1, 'AF', 'Afghanistan', 93),
(2, 'AL', 'Albania', 355),
(3, 'DZ', 'Algeria', 213),
...
SET IDENTITY_INSERT UOMs ON
INSERT INTO UOMs(ID, name, description) VALUES
(1,'kG','KiloGram'),
(2,'gram','Gram'),
(3,'m','meter'),
(4,'cm','cenimeter')
SET IDENTITY_INSERT UOMs OFF

SET IDENTITY_INSERT Discounts ON
INSERT INTO Discounts(ID, TaxCode, Value) VALUES
(1,'abc10',10),
(2,'abc20',20),
(3,'abc50',50)
...
INSERT INTO items(ID, name, price, quatity, description, size, color, image, Category_Id,UOM_ID) VALUES
(1,'orange',50,10000,'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.',1,'orange','orange.jpg',5,1),
(2,'apple',70,1000,'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.',1,'orange','orange.jpg',5,1),
(3,'orange',20,0,'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.',1,'orange','orange.jpg',5,1)
SET IDENTITY_INSERT items OFF

SET IDENTITY_INSERT statuses ON
INSERT INTO statuses(Id,state) VALUES
(1,'Order confirmed'),
(2,'Picked by courier'),
(3,'On the way'),
(4,'Ready for pickup')
