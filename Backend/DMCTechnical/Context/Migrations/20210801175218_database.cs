    ...
    public partial class database : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_headerCustomers", x => x.ID);
                    table.ForeignKey(
                        name: "FK_headerCustomers_AspNetUsers_customerID",
                        column: x => x.customerID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_headerCustomers_orderHeaders_orderHeaderID",
                        column: x => x.orderHeaderID,
                        principalTable: "orderHeaders",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_headerCustomers_customerID",
                table: "headerCustomers",
                column: "customerID");

            migrationBuilder.CreateIndex(
                name: "IX_headerCustomers_orderHeaderID",
                table: "headerCustomers",
